...
public class Geofencing extends FragmentActivity implements OnMapReadyCallback {
    ...
    private LatLng ESTS;//Start Pin for ESTS *TO CHANGE*
                        ...
                        new OnCompleteListener<Location>() {
                            ...
                            public void onComplete(@NonNull Task<Location> task) {
                                ...
                                if (location == null) {
                                    ...
                                    ESTS = new LatLng((int)location.getLatitude(), location.getLongitude());
                                    mMap.addMarker(new
                                                MarkerOptions().position(ESTS).title("Marker in Current Location"));
